...
/**
 * Intuition
Any square that lies inside the intersection of at least two rectangles must be fully contained within the overlapping region of at least two rectangles.

Therefore, the only candidates for the largest square are the intersections formed by every possible pair of rectangles.


The challenging part is determining that square.

The following diagram clarifies the process
Let's isolate two pairs of rectangle and determine the boundaries of the inner Largest square:
...
Then take the smaller dimension:

The Largest Square Contained Within a Pair of Rectangles:
Finally, take the square of the smaller dimension,
