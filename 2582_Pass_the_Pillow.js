...
/*
Approach
If we have N people it means we need n-1 passes to move pillow from the first one to the next. 
If we did even number of traversals it means we start next traversal from the first person, otherwise we start it from the nth person. 
Number of additional passses except full traversals could be calculated as time mod (n-1).
*/
