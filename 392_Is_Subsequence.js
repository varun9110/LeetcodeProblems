...
/**
 * Approach:
 * Use two pointer technique, one for t string and anothe for 2 string. keep incrementing if you find the character of s in t. 
 * At the end if the pointer is === to then length of s then true else false
 */
