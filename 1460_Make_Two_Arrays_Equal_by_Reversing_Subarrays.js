...
/**
 * Approach:
 * Sort both the arrays and check for each element, if equal return true else return false
 */
 ...
 * 
 * Another approach: 
 * is to create a mapper and record the frequency of each element in the object.
 * then keep subtracting the as per the appearence in the other array
 */
