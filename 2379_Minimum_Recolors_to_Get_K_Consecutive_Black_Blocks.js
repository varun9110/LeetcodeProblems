...
/**
 * Two pointer approach. count the number of whites from 0 till k. then when i>=k, then check if i-k was white then reduce the white count, and find the
 * min from min and current white count
 */
