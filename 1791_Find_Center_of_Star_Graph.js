...
/**
 * Approach:
 * Since star approach then there will definitly be 1 element common in all the elements. so just check if the 1st of first is there in the second element.
